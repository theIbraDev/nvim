...
vim.opt.signcolumn = "yes" -- Always show the signcolumn, otherwise it would shift the fjdskaøjfklød ajf kl~|jf klødj})({øa fklø ajf klaø jfkldøa fjkladøs jfsdklø fjadkløtext each time
